...
class Data():
	...
	"""
	@debug
	def __init__ (self, data = False, codebook = H144D, datapath = os.path.join("..","data","h144d.dat"), costId = ""):
...
def getData(datafile):
	...
	return Data(codebook = dataconfig[0], datapath = os.path.join("..", "data" , datafile), costId = dataconfig[1])
